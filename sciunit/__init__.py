...
class Test(object):
	...
	def __init__(self, observation, name=None, **params):
			...
			if not isinstance(self.score_type, Score):
  ...
  def generate_score(self, observation, prediction):
  	...
  	No default implementation."""
  	raise NotImplementedError("Test %s does not implement generate_score."
  		% self.name)
  ...
  def judge(self, model):
  	...
  	3. Calls generate_score to generate a score.
    ...
    # 3.
    score = self.generate_score(self.observation, self.prediction)
    # 4.
