...
class NotebookTools(object):
    ...
    genDirName = 'GeneratedFiles' # Name of directory where files generated by do_notebook are stored
    genFileLevel = 2 # Number of levels up from notebook directory where generated files are stored
    ...
    def write_code(self, name, code):
        ...
        Files are created in a directory specified by genDirName (see function gen_file_path)
